      ...
      <div className='flex-container'>
        ...
        <div className='flexer'>
          ...
          <ul className=' kilimanjaro_widget'>
            <li>
              <NavLink to='/game'>fifa</NavLink>
            </li>
            <li>
              <NavLink to='/game'>CODM</NavLink>
            </li>
            <li>
              <NavLink to='/game'>PUBG</NavLink>
            </li>
            <li>
              <NavLink to='/game'>Warzone</NavLink>
            </li>
            <li>
              <NavLink to='/game'>Multipurpose</NavLink>
            </li>
            <li>
              <NavLink to='/game'>Minimal</NavLink>
            </li>
            <li>
              <NavLink to='/game'>Classic</NavLink>
            </li>
            <li>
              <NavLink to='/game'>Medical</NavLink>
            </li>
          </ul>
        </div>
